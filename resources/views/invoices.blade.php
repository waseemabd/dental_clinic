                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0">
                            ...
                            <tr>
                                <td>1</td>
                                <td><a href="/invoice/1">#INV-0001</a></td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/edit-invoice/1"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                            <a class="dropdown-item" href="/invoice/1"><i class="fa fa-eye m-r-5"></i> View</a>
