                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table mb-0">
                            ...
                            <tbody>
                            <tr>
                                <td><img width="28" height="28" src="images/user.jpg" class="rounded-circle m-r-5" alt=""> Henry Daniels</td>
                                <td>Cardiology</td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/edit-schedule/1"><i class="fa fa-pencil m-r-5"></i> Edit</a>
